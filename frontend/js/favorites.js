...
class FavoritesManager {
    ...
    async addFavorite(songId) {
        ...
        try {
            // Get song details
            const song = await window.api.getSong(songId);
            if (!song) {
            ...
            await window.api.addFavorite(favoriteData);
            ...
            this.showSuccess(`Added "${song.title}" to favorites`);
            this.dispatchFavoriteEvent('favorite-added', { songId, song });
